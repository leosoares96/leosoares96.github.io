    ...
    items: [
      {
        ...
        description:
          'Plataforma fullstack orientada a dados desenvolvida para o Departamento de Estradas de Rodagem de São Paulo (DER-SP), permitindo a gestão operacional de obras públicas por meio de APIs, modelagem relacional e dashboards analíticos para monitoramento, relatórios e tomada de decisão.',
        tags: [
          'PostgreSQL',
          'Modelagem de Dados',
          'Node.js',
