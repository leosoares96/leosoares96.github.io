export const pt = {
  ...
  hero: {
    ...
    subtitle:
      'Projetando plataformas de dados escaláveis e produtos confiáveis em ambientes corporativos.',
    cta: 'Ver Experiência',
    projects: 'Projetos',
    github: 'GitHub',
    contact: 'Contato',
  ...
  certifications: {
    ...
    items: [
      ...
      { name: 'Itaú Unibanco – Qualidade em Mudanças', year: 2025 },
    ...
    items: [
      {
        ...
        description:
          'Consolidação de dados de fluxo de clientes PF e PJ (TED, boleto, TEF, débito automático, cartões, Pix) – Itaú',
        link: 'https://github.com/Leosoares96',
      },
      {
        title: 'Arquitetura de Dados Microcrédito',
        description:
          'Desenho e construção da arquitetura de dados do produto microcrédito no Itaú, produto em sua fase inicial.',
        link: 'https://github.com/Leosoares96',
      },
      {
        title: 'Projeto Atlas',
        description:
          'Modernização de dados e migração para Data Lake na GCP – Porto Seguro.',
        link: 'https://github.com/Leosoares96',
      },
      {
        title: 'Performance Unificado',
        description:
          'Construção do painel de monitoramento web omnichannel (Genesys, Avaya, WhatsApp, Chat) – Porto Seguro.',
        link: 'https://github.com/Leosoares96',
      },
    ],
  },
  awards: {
    sectionTitle: 'Reconhecimentos',
    items: [
      {
        name: '3x PRAD – Programa de Reconhecimento de Alto Desempenho',
        detail: 'Itaú – 2023, 2024, 2025',
      },
      {
        name: 'Bolsa de Intercâmbio',
        detail: 'University of Cincinnati – ETEC 2015',
      },
      { name: 'Melhor Aluno', detail: 'ETEC Itaquaquecetuba – 2014' },
    ],
  },
  contact: {
